 ...
 * @endcode
 */
$settings['hash_salt'] = 'AMUNR_rzumaycJ1MZ8JIiS2VqZJ7jtf3gaSop1LMI2AiJ6BI1v3-FU1jleBkAdsJxw5rG8aMwQ';
...
if (null !== (getenv('DRUPAL_ENVIRONMENT'))) {
  switch (getenv('DRUPAL_ENVIRONMENT')) {
    case 'local':
      $config['config_split.config_split.dev_split']['status'] = TRUE;
      break;
    case 'testing':
      $config['config_split.config_split.test_split']['status'] = TRUE;
      break;
    case 'production':
      $config['config_split.config_split.live_split']['status'] = TRUE;
      break;
  }
}
