 ...
 *
 * @Block(
 *   id = "consum_carousel_unlimited_block",
 *   admin_label = @Translation("Slider TEST")
 * )
 */
class ConsumCarouselUnlimitedBlock extends BlockBase implements ContainerFactoryPluginInterface {
