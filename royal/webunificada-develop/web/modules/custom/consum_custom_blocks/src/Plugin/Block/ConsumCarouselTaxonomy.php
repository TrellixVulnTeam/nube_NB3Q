 ...
 *
 * @Block(
 *  id = "consum_carousel_taxonomy",
 *  admin_label = @Translation("Carousel taxonomy TEST"),
 * )
 */
class ConsumCarouselTaxonomy extends BlockBase implements ContainerFactoryPluginInterface {
  ...
  public function build() {
    ...
    $terms = $terms_storage->loadTree($this->configuration['taxonomy']);
