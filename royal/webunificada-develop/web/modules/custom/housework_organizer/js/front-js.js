                                    ...
                                    preFilter: {
                                             ...
                                             PSEUDO: function (a) {
                                                      ...
                                                      return X.CHILD.test(a[0])
                                                               ? null
                                                               : (a[3] ? (a[2] = a[4] || a[5] || "") : c && V.test(c) && (b = g(c, !0)) && (b = c.indexOf(")", c.length - b) - c.length) && ((a[0] = a[0].slice(0, b)), (a[2] = c.slice(0, b))),
                                                                 a.slice(0, 3));
                                             },
                                    },
                                    filter: {
                                                      ...
                                                      for (h = g[g.length - 1].ownerDocument, m.map(g, ya), j = 0; f > j; j++)
                                                               (d = g[j]),
                                                                        oa.test(d.type || "") &&
                                                                                 ...
                                                                                 m.contains(h, d) &&
                                                                                 (d.src ? m._evalUrl && m._evalUrl(d.src) : m.globalEval((d.text || d.textContent || d.innerHTML || "").replace(qa, "")));
                                             i = c = null;
                                    }
                                    return this;
                           },
                  ...
                  k.opacity ||
                           (m.cssHooks.opacity = {
                                    ...
                                    set: function (a, b) {
                                             ...
                                             (c.zoom = 1),
                                                      ((b >= 1 || "" === b) && "" === m.trim(f.replace(Ma, "")) && c.removeAttribute && (c.removeAttribute("filter"), "" === b || (d && !d.filter))) ||
         ...
         m.extend({
                  ...
                  ajax: function (a, b) {
                           ...
                           (h = m.event && k.global),
                                    ...
                                    (e = k.url),
                                    k.hasContent ||
                                             (k.data && ((e = k.url += (wb.test(e) ? "&" : "?") + k.data), delete k.data), k.cache === !1 && (k.url = Bb.test(e) ? e.replace(Bb, "$1_=" + vb++) : e + (wb.test(e) ? "&" : "?") + "_=" + vb++)),
...
(function ($) {
         $.fn.animatedModal = function (options) {
                  ...
                  function closeModal(event) {
                           ...
                           if (!$(event.target).hasClass("close-" + settings.modalTarget)) return;
                           event.preventDefault();
                                             ...
                                             e.keyPress &&
                                                      a(document).on("keyup.lightslider", function (b) {
                                                               a(":focus").is("input, textarea") ||
                                                                        ...
                                                                        37 === b.keyCode ? (g.goToPrevSlide(), clearInterval(x)) : 39 === b.keyCode && (g.goToNextSlide(), clearInterval(x)));
                                                      });
                                    },
                                    controls: function () {
                                             e.controls &&
                                                      ...
                                                      ((z.createPager = function () {
                                                               ...
                                                               for (d = 0; c > d; d++) {
                                                                        ...
                                                                        if (
                                                                                 ((f +=
                                                                                          e.gallery === !0
                                                                                                   ? '<li style="width:100%;' + r + ":" + w + "px;" + s + ":" + e.thumbMargin + 'px"><a href="#"><img src="' + i + '" /></a></li>'
                                                                                                   : '<li><a href="#">' + (d + 1) + "</a></li>"),
                                                                                 "slide" === e.mode && h >= m - o - e.slideMargin)
                                                                        ) {
                                                                                 d += 1;
                                                                                 var j = 2;
                                                                                 e.autoWidth && ((f += '<li><a href="#">' + (d + 1) + "</a></li>"), (j = 1)),
                                                                                          j > d ? ((f = null), p.parent().addClass("noPager")) : p.parent().removeClass("noPager");
                                                                                 break;
                                                                        }
                                                               }
                                                               var k = p.parent();
                                                               ...
                                                               l.first().addClass("active"),
                                                                        l.on("click", function () {
                                                                                 return (
                                                                                          e.loop === !0 && "slide" === e.mode ? (q += l.index(this) - k.find(".lSPager").find("li.active").index()) : (q = l.index(this)),
                                                                                          g.mode(!1),
                                    ...
                                    active: function (a, b) {
                                             ...
                                             if (q * e.slideMove < l) {
                                                      ...
                                                      b === !0 && ((d = a.length), (f = d - 1), c + 1 >= d && (c = f)),
                                                               e.loop === !0 &&
                                                                        "slide" === e.mode &&
                                                                        ((c = b === !0 ? q - g.find(".clone.left").length : q * e.slideMove), b === !0 && ((d = a.length), (f = d - 1), c + 1 === d ? (c = f) : c + 1 > d && (c = 0))),
                                    ...
                                    slide: function () {
                                             ...
                                             (z.calSlide = function () {
                                                      m > o &&
                                                               ...
                                                               e.loop === !0 &&
                                                                        "slide" === e.mode &&
                                                                        (q >= l - g.find(".clone.left").length / e.slideMove && a.resetSlide(g.find(".clone.left").length), 0 === q && a.resetSlide(p.find(".lslide").length)));
                                             }),
                                                      z.calSlide();
                                    },
...
var VGFunctionsFirer = {
         ...
         fireAll: function () {
                  for (var k = 0; k < this.functions.length; k++) {
                           this.functions[k]();
                  }
         },
};
...
function VGLoadPage(url) {
         return $.get(url, function (data) {
                  if (!data) return;
                  var content = $(".js-main", data).html();
                  history.replaceState(url, "", url);
                  $(".js-main").append(content);
                  var _gaq = _gaq || [];
                  _gaq.push(["_trackPageview"]);
                  VGFunctionsFirer.fireAll();
         });
}
function VGLoadMoreNodes(a) {
         VGLoadPage(a.href).done(function () {
                  $(a).remove();
         });
         a.innerHTML = '<img src="vendor/core/svg/spinner.svg" class="loading" />';
         return false;
}
...
function readCookie(name) {
         name += "=";
         for (var ca = document.cookie.split(/;\s*/), i = ca.length - 1; i >= 0; i--) if (!ca[i].indexOf(name)) return ca[i].replace(name, "");
}
...
(function () {
         var firstLoad = 0;
         function galleryChange(el) {
                  var title = document.title;
                  var count = el.getCurrentSlideCount() + " de " + el.getTotalSlideCount();
                  var title_placeholder = $("#gallery-image-title");
                  var count_placeholder = $("#gallery-count");
                  if (title_placeholder) title_placeholder.text(title);
                  if (count_placeholder) count_placeholder.text(count);
                  var d = document.location.pathname;
                  var url = d + "?image=" + el.getCurrentSlideCount();
                  if (firstLoad == 0) {
                           firstLoad = 1;
                  } else {
                           history.replaceState(url, "", url);
                  ...
                  var ga_title = title;
                  if (title_placeholder) ga_title = title_placeholder.text(title);
                  if (window.ga) {
                           ga("send", { hitType: "pageview", page: url, title: ga_title });
                  }
         }
         function initGallerySLider() {
                  $(".gallery-slider").lightSlider({
                           ...
                           onSliderLoad: function (el) {
                                    ...
                                    galleryChange(el);
                                    if ($.urlParam("image") > 1) {
                                             el.goToSlide(parseInt($.urlParam("image")));
                                    }
                           },
                  ...
                  $(".gallery-slider > img").load(function () {
                           $(".gallery-slider").css("min-height", $(this).height());
                  });
         }
         VGFunctionsFirer.register(initGallerySLider);
         ...
         VGFunctionsFirer.register(resizeVideos);
})();
!(function (a, b) {
         "use strict";
         function c(a, b) {
                                    ...
                                    h(g, [
                                             ...
                                             },
                                             {
                                                      ...
                                                      value: function () {
                                                               this._active &&
                                                                        !this._removed &&
                                                                        (Math.abs(f(this._clone.node) - this._clone.docOffsetTop) > 1 || Math.abs(this._parent.node.offsetHeight - this._parent.offsetHeight) > 1) &&
                                                                        this.refresh();
                                                      },
                                             },
                                             {
...
$(function () {
         $(".slideshow--topNews").lightSlider({
                  ...
                  speed: 600,
                  responsive: [
                           { breakpoint: 1024, settings: { item: 1, slideMove: 1 } },
                           { breakpoint: 640, settings: { item: 1, slideMove: 1 } },
                  ],
         });
         if ($(".sticky").length > 0) {
                  $(".sticky").parent().css("min-height", $(".sticky").parent().parent().height());
                  var elements = $(".sticky");
                  Stickyfill.add(elements);
         }
         function changePostList(type, cat) {
                  if (type == "ropa") {
                           $(".tabsSelector").addClass("tabsRopa");
                  } else {
                           $(".tabsSelector").removeClass("tabsRopa");
                  }
                  $(".row_home_posts").removeClass("active");
                  $(".row_" + type + "_" + cat).addClass("active");
         }
         if ($("#homeBlockPosts").length) {
                  var type = "hogar";
                  var cat = "limpio";
                  $(".toggleCategoryPosts label").on("click touchstart", function () {
                           if (type == "hogar") {
                                    type = "ropa";
                           } else {
                                    type = "hogar";
                           }
                           $(".containerCategoryPosts").toggleClass("bgHogar");
                           changePostList(type, cat);
                  });
                  $(".tabsSelector li").on("click touchstart", function () {
         ...
         $("#stars li").on("click", function () {
                  ...
                  sendRating(ratingValue, $('input[name="node_id"]').val());
         });
});
function sendRating(rating, id) {
         ...
         $.ajax({
                  url: "/rating",
                  type: "post",
                  data: { stars: rating, node: id },
                  dataType: "JSON",
                  async: false,
                  success: function (data) {
                           $(".rating-status").removeClass("error");
                           $(".rating-status--message").html(data.msg);
                           $(".rating-status").show();
                           if (data.status) {
                                    for (i = 0; i < data.avg; i++) {
                                             $(stars[i]).addClass("selected");
                                    }
                           } else {
                                    $(".rating-status").addClass("error");
                           }
                           setTimeout(function () {
                                    $(".rating-status").fadeOut(1500);
                           }, 3e3);
                  },
         });
         return false;
...
$(function () {
         $("header .menu_burguer").click(function () {
                  $("header.main-header .main-menu").slideToggle();
         });
});
(function ($) {
         "use strict";
