...
/**
 * @file
 * Contains \Drupal\consum_mundoconsum\Plugin\Block\MyCouponsListBlock.
 */
 ...
 *
 * @Block(
 *   id = "mycoupons_list_block",
 *   admin_label = @Translation("My Coupons List Block")
 * )
 */
class MyCouponsListBlock extends MundoConsumBlockBase {
